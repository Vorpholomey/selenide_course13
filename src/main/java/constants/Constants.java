...
public class Constants {
    public static final String JOIN_ON_COURSE_TEXT = "Поступить на курс";
    ...
    public static final String FONT_SIZE_BUTTON_STYLE = "16px";
    public static final String PADDING_BUTTON_STYLE = "9px 25px";
    public static final int MAX_RETRIES = 5;
    public static final int DELAY_FOR_WAIT_ELEMENTS = 7000;
